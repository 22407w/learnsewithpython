...
class MyHomePageTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.driver.get('https://zfwzxx.www.gov.cn/')

    def test_search_text_field_max_length(self):
        # get the search textbox
        search_field = self.driver.find_element_by_id('queryInput')
    ...
    def test_search_button_enabled(self):
        # get Search button
        search_button = self.driver.find_element_by_class_name('btn_srh') #'button')
    ...
    def test_my_account_link_is_displayed(self):
        ...
        account_link = self.driver.find_element_by_link_text('数据库信息下载')
    ...
    def test_account_links(self):
        ...
        account_links = self.driver.\
            find_elements_by_partial_link_text('政策')

        # check Account and My Account link is
        # displayed/visible in the Home page footer
        self.assertEqual(2, len(account_links))

    def test_count_of_footer_banners_images(self):
        # get promo banner list
        banner_list = self.driver.find_element_by_class_name('footer3')
